		...
		<div class="container">
			<div class="hidden-xs">
				...
				<div class="pull-right">
					<a target="_blank" href="http://www.sexlaba.com">色喇叭</a>
				</div>
				<div class="clearfix"></div>
			</div>
			<div class="visible-xs"><span>{t c='footer.copyright'} &#169; 2008-2017</span> {$site_name}<br />Powered by <a target="_blank" href="http://www.sexlaba.com">www.sexlaba.com</a></div>
		</div>
	</div>
</div>
</div>
