...
{
	return '<div class="alert alert-dismissable alert-danger m-t-15 m-b-0"><button type="button" class="close" data-dismiss="alert">脳</button>'.$exp.'</div>';
}

function show_msg ($exp)
{
	return '<div class="alert alert-dismissable alert-success m-t-15 m-b-0"><button type="button" class="close" data-dismiss="alert">脳</button>'.$exp.'</div>';
}

function show_err_mb ($exp)
{
	return '<div class="alert alert-dismissable alert-danger m-b-15 m-b-0"><button type="button" class="close" data-dismiss="alert">脳</button>'.$exp.'</div>';
}

function show_msg_mb ($exp)
{
	return '<div class="alert alert-dismissable alert-success m-b-15 m-b-0"><button type="button" class="close" data-dismiss="alert">脳</button>'.$exp.'</div>';
}
