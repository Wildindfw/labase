...
jQuery.fn.floatadv = function(loaded) {
 ...
 if(!IsPC()){
    ...
    //   if(data){
    //       $(".wrap-logo").prepend('<div style="position:absolute;top:22px;right:160px;font-size:16px;padding:5px;width:60px"><a style="color:red" href="/logout.php">ç™»å‡º</a></div> ');
    //   }else{
    //       $(".wrap-logo").prepend('<div style="position:absolute;top:22px;right:160px;font-size:16px;padding:5px;width:60px;"><a style="color:red" href="/login.php">ç™»é™†</a></div> ');
    //   }
    ...
    //$(".sidebar .spots").hide();
      ...
      $(".kt-api-btn-start,.kt-api-btn-nostart").css("top","140px")
      ...
      $(".kt-api-btn-start,.kt-api-btn-nostart").css("right","90px");
      $(".kt-api-btn-start,.kt-api-btn-nostart").css("width","100px");
      $("#_iframe_content").find("img").css("height","100px").css('width','100px').css('padding-left','60px').css('padding-top','40px');
