		...
		<div class="well">
			<fieldset>
				...
				<center>
					...
					{if $fb_signin == '1'}					
						<div>
							<button id="facebook-signup" class="btn btn-facebook" disabled><div></div><i class="fa fa-facebook"></i> <span>{t c='socialsignup.signup_with'} Facebook</span></button>
						</div>
						<div class="hr">
					...
					{if $g_signin == '1'}
						<div>
							<button id="google-signup" class="btn btn-google" disabled><div></div><i class="fa fa-google-plus"></i> <span>{t c='socialsignup.signup_with'} Google</span></button>
						</div>
						<div class="hr">
							<div class="inner">{t c='socialsignup.or'}</div>
						</div>
