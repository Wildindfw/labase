			...
			<div class="col-md-12">
				<div class="grid simple">
					<div class="grid-title no-border">
						<h4>Editing: <span class="semi-bold">{$adv.adv_name}</span></h4>
					</div>
					<div class="grid-body no-border">
						<form class="form-no-horizontal-spacing" name="edit_adv" method="POST" action="index.php?m=advedit&AID={$adv.adv_id}">
							<div class="row">
								<div class="col-lg-6 col-lg-offset-3 col-md-12">
									<div class="row">
										...
										<div class="form-group">
											...
											<div class="col-lg-8">
												<input name="adv_name" type="text" value="{$adv.adv_name}" class="form-control {if $err.adv_name}error{/if}">
											</div>
											<div class="clearfix"></div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="col-lg-8">
												<div class="radio p-t-9">
													<input id="adv_status_a" type="radio" name="adv_status" value="1" {if $adv.adv_status == '1'}checked="checked"{/if} class="radio-enabled">
													<label for="adv_status_a">Active</label>
													<input id="adv_status_i" type="radio" name="adv_status" value="0" {if $adv.adv_status == '0'}checked="checked"{/if} class="radio-disabled">
